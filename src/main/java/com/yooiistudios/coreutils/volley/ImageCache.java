...
/**
 * Use
 * {@link ImageCache#getInstance(Resources resources, android.support.v4.app.FragmentManager, ImageCacheParams)}
...
public class ImageCache implements ImageLoader.ImageCache {
     ...
     * {@link ImageCache#getInstance(Resources resources, android.support.v4.app.FragmentManager, ImageCacheParams)} to fetch an ImageCache
     * instance.
     *
     * @param cacheParams The cache parameters to use to initialize the cache
     */
    private ImageCache(Resources resources, ImageCacheParams cacheParams) {
        init(resources, cacheParams);
    }
     ...
     */
    public static ImageCache getInstance(Resources resources,
        ...
        if (imageCache == null) {
            imageCache = new ImageCache(resources, cacheParams);
    ...
    public static ImageCache createNewInstance(Resources resources, ImageCacheParams cacheParams) {
        return new ImageCache(resources, cacheParams);
    }
    ...
    public Bitmap getBitmap(String url) {
        BitmapDrawable bitmapDrawable = getBitmapFromMemCache(url);
        Bitmap bitmap;
